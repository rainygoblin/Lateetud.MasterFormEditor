            ...
            var AutomationUpdateObjectDialog = (function () {
                function AutomationUpdateObjectDialog() {
                    ...
                    this.generateDialogTabs = function () {
                        var body = "";
                        body += "<ul  style='display:none !important' class='nav nav-tabs'>";
            ...
            var ContentPage = (function () {
                function ContentPage() {
                    ...
                    this.createUIElement = function () {
                        ...
                        //vipul
                        htmlOut += "<input type='type' id='contentTextArea' placeholder='Enter field name' class='form-control' name='name' value='' />";
                        //vipul
                        //htmlOut += "</textarea>";
                        htmlOut + "</div>";
            ...
            var ListTreeNode = (function () {
                ...
                ListTreeNode.prototype.createTreeNode = function () {
                    ...
                    if (this._contextMenu) {
                        ...
                        $("#annTreeNodeContextMenu .menuItem").bind("click", $.proxy(function () { _this._canHideContextMenu = true; }, this));
                ...
                ListTreeNode.prototype.touchstart = function (e) {
                    ...
                    this._touchHoldTimeOutHandler = window.setTimeout(function () {
                        if (_this._isTouchHold && e.target.localName != "textarea") {
                            _this.showContextMenu(_this._currentTouchPoint);
                            _this._canHideContextMenu = false;
                        }
                    }, 500);
                };
                ...
                ListTreeNode.isTouchDevice = function () {
                    try {
    ...
    (function (Annotations) {
        ...
        (function (JavaScript) {
            var AnnObjectTreeNode = (function (_super) {
                ...
                function AnnObjectTreeNode(automation, imageViewer, annContainer, annObject) {
                    if (automation == null)
                ...
                AnnObjectTreeNode.createContextMenu = function () {
                    var menuHtml = "";
                    menuHtml += "<div id='annTreeNodeContextMenu' class='dropup clearfix' tabindex='-1'>";
                ...
                AnnObjectTreeNode.prototype.contentTextArea_Change = function (e) {
                    this._annObject.metadata[lt.Annotations.Core.AnnObject.contentMetadataKey] = this._contentTextArea.value;
                    this._automation.invalidate(lt.LeadRectD.empty);
                };
            ...
            var AutomationObjectsListControl = (function () {
                        ...
                        for (var i = 0; i < this._automation.containers.count; i++) {
                            ...
                            if (container.children.count > 0) {
                                ...
                                if (pageNode) {
                                    ...
                                    pageNode = new JavaScript.PageTreeNode(this._automation, this._imageViewer, container);
                ...
                AutomationObjectsListControl.prototype.populateContainer = function (annContainer) {
                    ...
                    if (pageNode) {
                        ...
                        if (annContainer.children.count > 0) {
                            pageNode = new JavaScript.PageTreeNode(this._automation, this._imageViewer, annContainer);
                            pageNode.updateContent();
                            this._pages.push(pageNode);
    ...
    (function (Annotations) {
        ...
        (function (JavaScript) {
            var PageTreeNode = (function (_super) {
                ...
                function PageTreeNode(automation, imageViewer, annContainer) {
                    if (automation == null)
                        throw new Error("automation cannot be null");
                    if (imageViewer == null)
                        throw new Error("imageViewer cannot be null");
                ...
                PageTreeNode.prototype.updateContent = function () {
                    ...
                    for (var j = 0; j < this._annContainer.children.count; j++) {
                        ...
                        if (annObject.id != lt.Annotations.Core.AnnObject.selectObjectId && annObject.id != lt.Annotations.Core.AnnObject.none) {
                            var annNode = new JavaScript.AnnObjectTreeNode(this._automation, this._imageViewer, this._annContainer, annObject);
        ...
        (function (JavaScript) {
            var ReviewTreeNode = (function (_super) {
                ...
                ReviewTreeNode.createContextMenu = function () {
                    var menuHtml = "";
                    menuHtml += "<div id='annReviewNodeContextMenu' class='dropup clearfix' tabindex='-1'>";
                    menuHtml += "<ul class='dropdown-menu' role='menu' aria-labelledby='dropdownMenu' style='display:block;margin-bottom:5px;'>";
                    menuHtml += "<li>";
        ...
        (function (JavaScript) {
            var ReviewsPage = (function () {
                ...
                ReviewsPage.prototype.updateContent = function (annObject) {
                    ...
                    if (isNUllOrEmptyString(lastModified))
                        lastModified = "[date]";
        ...
        (function (JavaScript) {
            ...
            var AutomationManagerHelper = (function () {
                function AutomationManagerHelper(manager, resourcesPath) {
                    ...
                    if (lt.LTHelper.supportsMouse) {
                        document.addEventListener("keydown", function (evt) {
                            if (evt.keyCode == AutomationManagerHelper._shiftKey)
                                AutomationManagerHelper._shiftKeyDown = true;
                            if (evt.keyCode == AutomationManagerHelper._ctrlKey)
                                AutomationManagerHelper._ctrlKeyDown = true;
                            if (evt.keyCode == AutomationManagerHelper._altKey)
                                AutomationManagerHelper._altKeyDown = true;
                        }, false);
                        document.addEventListener("keyup", function (evt) {
                            if (evt.keyCode == AutomationManagerHelper._shiftKey)
                                AutomationManagerHelper._shiftKeyDown = false;
                            if (evt.keyCode == AutomationManagerHelper._ctrlKey)
                                AutomationManagerHelper._ctrlKeyDown = false;
                            if (evt.keyCode == AutomationManagerHelper._altKey)
                                AutomationManagerHelper._altKeyDown = false;
                        }, false);
                ...
                AutomationManagerHelper.checkModifierKey = function (annKey) {
                    if ((annKey & lt.Annotations.Core.AnnKeys.shift) == lt.Annotations.Core.AnnKeys.shift)
                        return AutomationManagerHelper._shiftKeyDown;
                    if ((annKey & lt.Annotations.Core.AnnKeys.control) == lt.Annotations.Core.AnnKeys.control)
                        return AutomationManagerHelper._ctrlKeyDown;
                    if ((annKey & lt.Annotations.Core.AnnKeys.alt) == lt.Annotations.Core.AnnKeys.alt)
                        return AutomationManagerHelper._altKeyDown;
                    return false;
                };
                ...
                AutomationManagerHelper._shiftKey = 16;
                AutomationManagerHelper._ctrlKey = 17;
                AutomationManagerHelper._altKey = 18;
                AutomationManagerHelper._shiftKeyDown = false;
                AutomationManagerHelper._ctrlKeyDown = false;
                AutomationManagerHelper._altKeyDown = false;
